...
export const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "docCheck.person.birthDate": "Nascimento",
    "docCheck.person.email": "E-mail",
    "docCheck.person.phone": "Telefone",
    "docCheck.person.address": "Endereço",
    "docCheck.person.zipCode": "CEP",
    "docCheck.person.franchises": "Franquias",
    "docCheck.error.invalid": "Documento inválido. Verifique e tente novamente.",
    "docCheck.error.network": "Não foi possível validar o documento agora. Tente novamente.",
  ...
  en: {
    ...
    "docCheck.person.birthDate": "Date of birth",
    "docCheck.person.email": "Email",
    "docCheck.person.phone": "Phone",
    "docCheck.person.address": "Address",
    "docCheck.person.zipCode": "ZIP Code",
    "docCheck.person.franchises": "Franchises",
    "docCheck.error.invalid": "Invalid document. Please check and try again.",
    "docCheck.error.network": "Unable to validate document right now. Please try again.",
  ...
  es: {
    ...
    "docCheck.person.birthDate": "Nacimiento",
    "docCheck.person.email": "Correo",
    "docCheck.person.phone": "Teléfono",
    "docCheck.person.address": "Dirección",
    "docCheck.person.zipCode": "Código Postal",
    "docCheck.person.franchises": "Franquicias",
    "docCheck.error.invalid": "Documento inválido. Verifique e intente nuevamente.",
    "docCheck.error.network": "No fue posible validar el documento ahora. Intente nuevamente.",
