        ...
        <CardContent className="space-y-6">
          ...
          >
            <div className="space-y-6">
              {step === 1 && <StepPersonal data={data} onChange={onChange} errors={errors} docCheckError={docCheckError} docBlocked={docBlocked} showDocCheck={showDocCheck} docChecking={docChecking} docCheckResult={docCheckResult} />}
