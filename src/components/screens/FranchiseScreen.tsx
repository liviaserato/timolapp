            ...
            >
              ...
              {(() => {
                ...
                return (
                  <div
                    className={cn(
                      "flex flex-col gap-4 px-4 pt-5 pb-4 rounded-t-[calc(0.5rem-2px)]",
                      isSelected ? "bg-[#FEFAD2]" : "bg-primary/5"
                    )}
                  >
                    <div className="flex items-start gap-3 min-w-0">
                      <Icon className={cn(
                        "h-7 w-7 flex-shrink-0 mt-0.5",
                        isSelected ? "text-yellow-800" : "text-primary/60"
                      )} />
                      <div className="min-w-0">
                        <span className={cn(
                          "block text-xs font-medium uppercase tracking-wider leading-tight",
                          isSelected ? "text-yellow-800" : "text-primary/60"
                        )}>
                          {franchiseLabel[lang]}
                        </span>
                        <h3 className={cn(
                          "text-xl font-extrabold leading-tight uppercase break-words",
                    ...
                    <div
                      className={cn(
                        ...
                        isSelected ? "border-yellow-400/60 bg-white/50" : "border-border/60 bg-background/70"
                      )}
                    >
                      {currency === "BRL" ? (
                        <>
                          <div className="flex items-start justify-between gap-3">
                            <span className="pt-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">
                              {f.installments}x
                            </span>
                            <div className="flex items-baseline justify-end gap-0.5 min-w-0 text-right">
                        ...
                        <div className="flex items-end justify-end gap-0.5 min-w-0 text-right">
                          <span className="text-[11px] text-muted-foreground font-medium">{sym}</span>
                          <span className="text-3xl font-extrabold text-foreground leading-none tracking-tight break-words">
